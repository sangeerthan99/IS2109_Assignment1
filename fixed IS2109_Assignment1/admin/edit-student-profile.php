...
header('location:index.php');
  ...
  if(isset($_POST['submit'])) {
    ...
    $stmt = mysqli_prepare($con, "UPDATE students SET studentName=?, studentPhoto=?, cgpa=? WHERE StudentRegno=?");
    mysqli_stmt_bind_param($stmt, "ssdi", $studentname, $photo, $cgpa, $regid);
    
    if (move_uploaded_file($_FILES["photo"]["tmp_name"], "studentphoto/".$_FILES["photo"]["name"]) && mysqli_stmt_execute($stmt)) {
